> Since PureCSS is no longer being maintained, please checkout [Hydrogen](https://github.com/pimbrouwers/HydrogenCSS) which has esstentially the same feature coverage as Pure as is being actively maintained!
